...
Welcome to the Natural Language Processing for Social Sciences User Guide provided by the Cornell Center for Social Sciences (CCSS)! This guide serves as both the written version of Spring 2022’s workshop under the same name as well as a standing reference available to wider Cornell community. 

Are you… 

*	Not too familiar with NLP and are looking for a broad view on the discipline as applicable to social sciences?
*	Curious about ways you could potentially incorporate NLP into your research?
...
You’ll be able to navigate through the individual chapters of the guide through the index to the left. The chapters do build from each other particularly  regarding the core concepts and coding components, but can stand alone for each topic as well. 
